...
var len__4829__auto___57983 = arguments.length;
var i__4830__auto___57984 = (0);
while(true){
if((i__4830__auto___57984 < len__4829__auto___57983)){
args__4835__auto__.push((arguments[i__4830__auto___57984]));

var G__57985 = (i__4830__auto___57984 + (1));
i__4830__auto___57984 = G__57985;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq57926){
var G__57930 = cljs.core.first(seq57926);
var seq57926__$1 = cljs.core.next(seq57926);
var G__57931 = cljs.core.first(seq57926__$1);
var seq57926__$2 = cljs.core.next(seq57926__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57930,G__57931,seq57926__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__57936_SHARP_){
return (!((cljs.core.meta(p1__57936_SHARP_) == null)));
})))){
...
var map__57955 = opts;
var map__57955__$1 = cljs.core.__destructure_map(map__57955);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57955__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e57956){var _e__56822__auto__ = e57956;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e57958){var _e__56822__auto__ = e57958;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__57963 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__57964 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__57964);

try{var map__57968 = opts;
var map__57968__$1 = cljs.core.__destructure_map(map__57968);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57968__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__57963);
}});
...
var temp__5751__auto___58023 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___58023)){
var managed_print_level_58024 = temp__5751__auto___58023;
var _STAR_print_level_STAR__orig_val__57973_58025 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__57974_58026 = managed_print_level_58024;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__57974_58026);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__57969_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__57969_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__57973_58025);
}} else {
job_fn();
}
