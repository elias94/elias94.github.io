...
var len__4818__auto___27681 = arguments.length;
var i__4819__auto___27682 = (0);
while(true){
if((i__4819__auto___27682 < len__4818__auto___27681)){
args__4824__auto__.push((arguments[i__4819__auto___27682]));

var G__27686 = (i__4819__auto___27682 + (1));
i__4819__auto___27682 = G__27686;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27615){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27616,G__27617,seq27615__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27641_SHARP_){
return (!((cljs.core.meta(p1__27641_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27649__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27650){var _e__26606__auto__ = e27650;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e27653){var _e__26606__auto__ = e27653;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27658 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27659 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27659);

try{var map__27660 = opts;
var map__27660__$1 = cljs.core.__destructure_map(map__27660);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27660__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27658);
}});
...
var temp__5751__auto___27714 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___27714)){
var managed_print_level_27715 = temp__5751__auto___27714;
var _STAR_print_level_STAR__orig_val__27667_27716 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27668_27717 = managed_print_level_27715;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27668_27717);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27663_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27663_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27667_27716);
}} else {
job_fn();
}
