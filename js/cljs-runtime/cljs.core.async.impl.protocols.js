...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28416 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28416(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28420 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28420(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28425 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28425(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28429 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28429(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28431 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28431(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28438 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28438(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28443 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28443(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28445 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28445(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28449 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28449(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28453 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28453(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28459 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28459(b);
}
});
