...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27962 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27962(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27966 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27966(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27968 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27968(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27972 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27972(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27974 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27974(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27975 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27975(reader);
}
});
...
var G__28049 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28050 = s.append(c);
c = G__28049;
s = G__28050;
continue;
}
