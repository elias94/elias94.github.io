...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_58191 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_58191(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_58196 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_58196(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58197 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58197(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58202 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58202(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58207 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58207(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58214 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58214(reader);
}
});
...
var G__58307 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__58308 = s.append(c);
c = G__58307;
s = G__58308;
continue;
}
