...
return (function() { 
var G__67228__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__67228 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__67232__i = 0, G__67232__a = new Array(arguments.length -  0);
while (G__67232__i < G__67232__a.length) {G__67232__a[G__67232__i] = arguments[G__67232__i + 0]; ++G__67232__i;}
  args = new cljs.core.IndexedSeq(G__67232__a,0,null);
} 
return G__67228__delegate.call(this,args);};
G__67228.cljs$lang$maxFixedArity = 0;
G__67228.cljs$lang$applyTo = (function (arglist__67233){
var args = cljs.core.seq(arglist__67233);
return G__67228__delegate(args);
});
G__67228.cljs$core$IFn$_invoke$arity$variadic = G__67228__delegate;
return G__67228;
})()
;
} else {
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__67240__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__67241__i < G__67241__a.length) {G__67241__a[G__67241__i] = arguments[G__67241__i + 0]; ++G__67241__i;}
  args = new cljs.core.IndexedSeq(G__67241__a,0,null);
} 
return G__67240__delegate.call(this,args);};
G__67240.cljs$lang$maxFixedArity = 0;
G__67240.cljs$lang$applyTo = (function (arglist__67243){
var args = cljs.core.seq(arglist__67243);
...
var G__67041 = props;
var G__67041__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67041,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__67041);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67041__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__67042 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67042,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__67042;
}
})(),id_class);
...
var G__67044 = (cljs.core.count(argv) - first_child);
switch (G__67044) {
case (0):
...
var vec__67059 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67059,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67059,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67059,(2),null);
...
var temp__5757__auto___67316 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___67316 == null)){
} else {
var key_67318 = temp__5757__auto___67316;
(jsprops.key = key_67318);
}
...
var temp__5757__auto___67321 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___67321 == null)){
} else {
var key_67324 = temp__5757__auto___67321;
(jsprops.key = key_67324);
}
...
var temp__5757__auto___67339 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___67339 == null)){
} else {
var key_67340 = temp__5757__auto___67339;
(jsprops.key = key_67340);
}
...
var temp__5757__auto___67362 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___67362 == null)){
} else {
var key_67363 = temp__5757__auto___67362;
(jsprops.key = key_67363);
}
...
var temp__5757__auto___67368 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___67368 == null)){
} else {
var key_67373 = temp__5757__auto___67368;
(jsprops.key = key_67373);
}
...
var ctx = ({});
var vec__67124 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67124,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67124,(1),null);
...
break;
default:
var G__67381 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__67382 = compiler;
v = G__67381;
compiler = G__67382;
continue;
...
var G__67159 = tag;
var G__67159__$1 = (((G__67159 instanceof cljs.core.Keyword))?G__67159.fqn:null);
switch (G__67159__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template67165 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template67165 = (function (opts,id,fn_to_element,parse_fn,meta67166){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template67165.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_67167,meta67166__$1){
var self__ = this;
var _67167__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template67165.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_67167){
var self__ = this;
var _67167__$1 = this;
return self__.meta67166;
}));

(reagent.impl.template.t_reagent$impl$template67165.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template67165.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template67165.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template67165.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template67165.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template67165.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta67166","meta67166",2131376922,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template67165.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template67165.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template67165");

(reagent.impl.template.t_reagent$impl$template67165.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template67165");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template67165.
 */
reagent.impl.template.__GT_t_reagent$impl$template67165 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template67165(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta67166){
