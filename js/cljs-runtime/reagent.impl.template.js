...
var G__37112 = o;
goog.object.set(G__37112,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37430__delegate = function (args){
...
while (G__37431__i < G__37431__a.length) {G__37431__a[G__37431__i] = arguments[G__37431__i + 0]; ++G__37431__i;}
  args = new cljs.core.IndexedSeq(G__37431__a,0,null);
} 
return G__37430__delegate.call(this,args);};
G__37430.cljs$lang$maxFixedArity = 0;
G__37430.cljs$lang$applyTo = (function (arglist__37432){
var args = cljs.core.seq(arglist__37432);
return G__37430__delegate(args);
});
...
var G__37122 = o;
goog.object.set(G__37122,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37435__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37437__i < G__37437__a.length) {G__37437__a[G__37437__i] = arguments[G__37437__i + 0]; ++G__37437__i;}
  args = new cljs.core.IndexedSeq(G__37437__a,0,null);
} 
return G__37435__delegate.call(this,args);};
G__37435.cljs$lang$maxFixedArity = 0;
G__37435.cljs$lang$applyTo = (function (arglist__37438){
var args = cljs.core.seq(arglist__37438);
return G__37435__delegate(args);
});
...
var G__37124 = props;
var G__37124__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37124,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37124);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37124__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37134 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37134,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37134;
}
})(),id_class);
...
var G__37135 = (cljs.core.count(argv) - first_child);
switch (G__37135) {
case (0):
...
var vec__37142 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37142,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37142,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37142,(2),null);
...
var temp__5757__auto___37457 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37457 == null)){
} else {
var key_37458 = temp__5757__auto___37457;
(jsprops.key = key_37458);
}
...
var temp__5757__auto___37462 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37462 == null)){
} else {
var key_37464 = temp__5757__auto___37462;
(jsprops.key = key_37464);
}
...
var temp__5757__auto___37470 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37470 == null)){
} else {
var key_37471 = temp__5757__auto___37470;
(jsprops.key = key_37471);
}
...
var temp__5757__auto___37479 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37479 == null)){
} else {
var key_37480 = temp__5757__auto___37479;
(jsprops.key = key_37480);
}
...
var temp__5757__auto___37481 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37481 == null)){
} else {
var key_37483 = temp__5757__auto___37481;
(jsprops.key = key_37483);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37219_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37219_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37244 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37244,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37244,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37340 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37340 = (function (opts,id,fn_to_element,parse_fn,meta37341){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta37341 = meta37341;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template37340.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37342,meta37341__$1){
var self__ = this;
var _37342__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37340(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37341__$1));
}));

(reagent.impl.template.t_reagent$impl$template37340.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37342){
var self__ = this;
var _37342__$1 = this;
return self__.meta37341;
}));

(reagent.impl.template.t_reagent$impl$template37340.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37340.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37340.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37340.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37340.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37340.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37341","meta37341",-1388451722,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37340.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37340.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37340");

(reagent.impl.template.t_reagent$impl$template37340.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template37340");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37340.
 */
reagent.impl.template.__GT_t_reagent$impl$template37340 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37340(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37341){
return (new reagent.impl.template.t_reagent$impl$template37340(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37341));
});

}

return (new reagent.impl.template.t_reagent$impl$template37340(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
