...
var temp__5751__auto___67974 = event.state;
if(cljs.core.truth_(temp__5751__auto___67974)){
var state_67975 = temp__5751__auto___67974;
var temp__5753__auto___67976 = (state_67975["scroll-top"]);
if(cljs.core.truth_(temp__5753__auto___67976)){
var scroll_top_67977 = temp__5753__auto___67976;
goog.events.listenOnce(window,goog.events.EventType.SCROLL,(function (){
scrollTo((0),scroll_top_67977);
...
var scroll_top_67978 = clerk.core.get_scroll_top();
var state_67979 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scroll-top","scroll-top",-46723100),scroll_top_67978], null);
history.replaceState(cljs.core.clj__GT_js(state_67979),document.title);
...
var len__4829__auto___67984 = arguments.length;
var i__4830__auto___67985 = (0);
while(true){
if((i__4830__auto___67985 < len__4829__auto___67984)){
args__4835__auto__.push((arguments[i__4830__auto___67985]));

var G__67986 = (i__4830__auto___67985 + (1));
i__4830__auto___67985 = G__67986;
continue;
} else {
}
break;
...
(clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__67948){
var vec__67949 = p__67948;
var top_element_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67949,(0),null);
...
/** @this {Function} */
(clerk.core.navigate_page_BANG_.cljs$lang$applyTo = (function (seq67938){
var G__67939 = cljs.core.first(seq67938);
var seq67938__$1 = cljs.core.next(seq67938);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67939,seq67938__$1);
}));
