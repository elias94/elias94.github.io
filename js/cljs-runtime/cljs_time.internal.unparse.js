...
var periods__$1 = cljs.core.vec((function (){var G__55921 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55919_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__55919_SHARP_,(0),(3));
}),G__55921);
} else {
return G__55921;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__55931){
var vec__55932 = p__55931;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55932,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55932,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__55935 = pattern;
switch (G__55935) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55935)].join('')));
...
switch (G__55944__$1) {
case "millis":
return (function (p1__55936_SHARP_){
return p1__55936_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__55937_SHARP_){
return p1__55937_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__55938_SHARP_){
return p1__55938_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__55939_SHARP_){
return p1__55939_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__55940_SHARP_){
return p1__55940_SHARP_.getHours();
});

break;
case "day":
return (function (p1__55941_SHARP_){
return p1__55941_SHARP_.getDate();
});

break;
case "month":
return (function (p1__55942_SHARP_){
return p1__55942_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__55943_SHARP_){
return p1__55943_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55944__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__55945){
...
var key = first__55948;
var args = seq__55947__$1;
var G__55949 = key;
...
break;
case "ordinal-suffix":
var vec__55950 = (function (){var G__55953 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__55953) : syntax_list.call(null,G__55953));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55949__$1)].join('')));
...
var d = value;
var G__55957 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__55958 = G__55957;
var seq__55959 = cljs.core.seq(vec__55958);
var first__55960 = cljs.core.first(seq__55959);
var seq__55959__$1 = cljs.core.next(seq__55959);
var unparser = first__55960;
var more = seq__55959__$1;
var s = "";
var d__$1 = d;
var G__55957__$1 = G__55957;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__55967 = G__55957__$1;
var seq__55968 = cljs.core.seq(vec__55967);
var first__55969 = cljs.core.first(seq__55968);
var seq__55968__$1 = cljs.core.next(seq__55968);
var unparser__$1 = first__55969;
var more__$1 = seq__55968__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__55970 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55970,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55970,(1),null);
var G__55999 = d__$3;
var G__56000 = more__$1;
var G__56001 = s__$3;
d__$1 = G__55999;
G__55957__$1 = G__56000;
s__$1 = G__56001;
continue;
}
break;
