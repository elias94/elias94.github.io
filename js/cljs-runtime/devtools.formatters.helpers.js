...
var G__57913 = devtools.prefs.pref(v);
v = G__57913;
continue;
} else {
return v;
...
}catch (e57873){var _e__56822__auto__ = e57873;
return false;
}})();
...
}catch (e57879){var _e__56822__auto__ = e57879;
return false;
}})();
...
}catch (e57882){var _e__56822__auto__ = e57882;
return false;
}}
}
});
...
var vec__57900 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57900,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57900,(1),null);
...
return cljs.core.some((function (p1__57903_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__57903_SHARP_);
}),template);
});
