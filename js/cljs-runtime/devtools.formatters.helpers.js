...
var G__27600 = devtools.prefs.pref(v);
v = G__27600;
continue;
} else {
return v;
...
}catch (e27579){var _e__26606__auto__ = e27579;
return false;
}})();
...
}catch (e27581){var _e__26606__auto__ = e27581;
return false;
}})();
...
}catch (e27583){var _e__26606__auto__ = e27583;
return false;
}}
}
});
...
var vec__27587 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27587,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27587,(1),null);
...
return cljs.core.some((function (p1__27594_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27594_SHARP_);
}),template);
});
