...
var o56924 = temp__5751__auto__;
var temp__5751__auto____$1 = (o56924["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o56926 = temp__5751__auto____$1;
return (o56926["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__56804__auto__ = f;
return (o__56804__auto__["toString"]).call(o__56804__auto__);
} else {
return "";
}
}catch (e56931){var _ = e56931;
return "";
}});
...
try{var o__56804__auto___57727 = t;
(o__56804__auto___57727["cljs$lang$ctorPrWriter"]).call(o__56804__auto___57727,t,writer);
}catch (e56944){var __57728 = e56944;
}
...
var char_code = (function (){var o__56804__auto__ = (new String(char$));
return (o__56804__auto__["charCodeAt"]).call(o__56804__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__56804__auto__ = String;
return (o__56804__auto__["fromCharCode"]).call(o__56804__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__56960 = num_code;
switch (G__56960) {
case (1):
return (185);
...
var o__56804__auto__ = String;
return (o__56804__auto__["fromCharCode"]).call(o__56804__auto__,superscript_code);
});
/**
...
}catch (e56990){var _e__56822__auto__ = e56990;
return false;
}})())){
...
var vec__56994 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56994,(0),null);
...
var len__4829__auto___57754 = arguments.length;
var i__4830__auto___57755 = (0);
while(true){
if((i__4830__auto___57755 < len__4829__auto___57754)){
args__4835__auto__.push((arguments[i__4830__auto___57755]));

var G__57756 = (i__4830__auto___57755 + (1));
i__4830__auto___57755 = G__57756;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__57063){
var vec__57066 = p__57063;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57066,(0),null);
...
var G__57758 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__57759 = cljs.core.butlast(remaining_tokens);
name_tokens = G__57758;
remaining_tokens = G__57759;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq57051){
var G__57052 = cljs.core.first(seq57051);
var seq57051__$1 = cljs.core.next(seq57051);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57052,seq57051__$1);
}));
...
var vec__57091 = cljs.core.split_with((function (p1__57086_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__57086_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57091,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57091,(1),null);
...
var vec__57108 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57108,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57108,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__57764 = cljs.core.rest(remaining_tokens);
var G__57765 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__57764;
name_tokens = G__57765;
continue;
} else {
...
var vec__57173 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57173,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57173,(1),null);
var vec__57176 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57176,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57176,(1),null);
var vec__57179 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57179,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57179,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57179,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57179,(3),null);
...
var vec__57215 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__57235 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57235,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57235,(1),null);
var vec__57239 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57239,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57239,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__57277 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__57277) : devtools.munging.parse_fn_info_deep.call(null,G__57277));
})()));
}
} else {
return fn_info;
...
var G__57831 = (arity + (1));
var G__57832 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__57335){
var vec__57344 = p__57335;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57344,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57344,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57401_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__57401_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57402_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__57402_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___57848 = arguments.length;
var i__4830__auto___57849 = (0);
while(true){
if((i__4830__auto___57849 < len__4829__auto___57848)){
args__4835__auto__.push((arguments[i__4830__auto___57849]));

var G__57851 = (i__4830__auto___57849 + (1));
i__4830__auto___57849 = G__57851;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__57436){
var vec__57439 = p__57436;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57439,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq57423){
var G__57424 = cljs.core.first(seq57423);
var seq57423__$1 = cljs.core.next(seq57423);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57424,seq57423__$1);
}));
...
var map__57529 = options;
var map__57529__$1 = cljs.core.__destructure_map(map__57529);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57529__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57529__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57529__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57529__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__57530 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57530,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57530,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57530,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57530,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57530,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57530,(5),null);
...
var o__56804__auto__ = f;
return (o__56804__auto__["getBasis"]).call(o__56804__auto__);
});
/**
...
}catch (e57579){var _e__56822__auto__ = e57579;
...
var G__57869 = (obj[cljs.core.first(path)]);
var G__57870 = cljs.core.rest(path);
obj = G__57869;
path = G__57870;
continue;
} else {
...
var _STAR_ = (function (accum,p__57658){
var vec__57660 = p__57658;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57660,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57660,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__57693){
var vec__57695 = p__57693;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57695,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57695,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57695,(2),null);
...
var post_process = (function (p__57708){
var vec__57711 = p__57708;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57711,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57711,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57701_SHARP_){
return (obj[cljs.core.first(p1__57701_SHARP_)]);
}),sorted_matches);
